...
internal class TestParsing
{
    ...
    public void TestInit()
    {
        ...
        Persist.Parse(/*lang=json,strict*/ $"{{\"Name\":\"InitCommand\",\"InitCommand\":{{\"ClientGuid\":\"{TestGuid}\",\"Version\":\"{TestVersion}\",\"AnalyzerFileName\":\"{TestAnalyzerFileName}\"}}}}");
        ...
        Persist.Parse(/*lang=json,strict*/ $"{{\"Name\":\"InitCommand\",\"InitCommand\":{{\"ClientGuid\":\"\",\"Version\": null,\"AnalyzerFileName\": null}}}}");
    ...
    public void TestExitWithEvent()
    {
        ...
        Persist.Parse(/*lang=json,strict*/ "{\"Name\":\"ExitCommand\",\"ExitCommand\":{\"Delay\":\"00:00:01\"}}");
    ...
    public void TestInitExit()
    {
        ...
        Persist.Parse(/*lang=json,strict*/ $"{{\"Name\":\"InitCommand\",\"InitCommand\":{{\"ClientGuid\":\"{TestGuid}\",\"Version\":\"{TestVersion}\",\"AnalyzerFileName\":\"{TestTools.TestAnalyzer}\"}}}}");
        Persist.Parse(/*lang=json,strict*/ "{\"Name\":\"UpdateCommand\",\"UpdateCommand\":{\"DeviceId\":\"{C5F19A64-5DDD-4B91-9F08-C2119E501BFE}\",\"Root\": null}}");
        Persist.Parse(/*lang=json,strict*/ "{\"Name\":\"ExitCommand\",\"ExitCommand\":{\"Delay\":\"00:00:00\"}}");
        Persist.Parse(/*lang=json,strict*/ "{\"Name\":\"ExitCommand\",\"ExitCommand\":{\"Delay\":\"00:00:00\"}}");
    }

    [Test]
    public void TestUpdate()
        => Persist.Parse(/*lang=json,strict*/ "{\"Name\":\"UpdateCommand\",\"UpdateCommand\":{\"DeviceId\":\"{C5F19A64-5DDD-4B91-9F08-C2119E501BFE}\",\"Root\":{\"Externs\":[],\"Usings\":[],\"AttributeLists\":[],\"Members\":[{\"$discriminator\":\"FileScopedNamespaceDeclarationSyntax\",\"AttributeLists\":[],\"NamespaceKeyword\":{\"Text\":\"namespace\"},\"Name\":{\"$discriminator\":\"IdentifierNameSyntax\",\"Identifier\":{\"Text\":\"Test\"},\"Parent\":{}},\"SemicolonToken\":{\"Text\":\";\"},\"Externs\":[],\"Usings\":[],\"Members\":[{\"$discriminator\":\"ClassDeclarationSyntax\",\"AttributeLists\":[],\"Keyword\":{\"Text\":\"class\"},\"Identifier\":{\"Text\":\"Foo\"},\"ConstraintClauses\":[],\"OpenBraceToken\":{\"Text\":\"{\"},\"Members\":[],\"CloseBraceToken\":{\"Text\":\"}\"},\"SemicolonToken\":{\"Text\":\"\"}}]}],\"EndOfFileToken\":{\"Text\":\"\"}}}}");
    ...
    public void TestInvalidCommand()
        => _ = Assert.Throws<ArgumentException>(() => Persist.Parse(/*lang=json,strict*/ "{\"Name\":\"None\"}"));
}
